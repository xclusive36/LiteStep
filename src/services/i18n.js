...
const resources = {
    en: {
        translation: {
            APP_NAME: "LiteStep",
            RESET_HEADER: "Warning!",
            RESET_SUBHEADER: "Are you sure?",
            CATEGORY_RESET_MESSAGE:
                "Are you sure you want to reset all counts for this category to zero?",
            ...
            CONFIRM: "OK",
            RESET: "Reset",
            EMPTY_CATEGORY: "Your category list is empty",
            EMPTY_ITEM: "Your item list is empty",
            EMPTY_SEARCH: "No search results",
            EMPTY_CATEGORY_PICK: "All categories have been picked!",
            EMPTY_ITEM_PICK: "All items have been picked!",
            CATEGORY_TITLE: "Categories",
            CATEGORYEDIT_TITLE: "Edit Categories",
            CATEGORY_PLACEHOLDER: "Add Category",
            ITEM_PLACEHOLDER: "Add Item",
            SEARCH_PLACEHOLDER: "Search",
            TOAST_LISTUPDATED: "List updated",
            TOAST_LISTRESTORED: "List restored",
            UPDATE_BUTTON: "Update Changes",
